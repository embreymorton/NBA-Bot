...
class Tweet:
    # Represents a tweet object -- containing text and potential media (image or video)
...
# Create Tweet objects for each tweet using ThreadPoolExecutor
with ThreadPoolExecutor() as executor:
    tweet_objects = executor.map(create_tweet, tweets)

# Convert to a list for random selection
